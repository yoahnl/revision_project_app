...
| DEC-012 | Les cours et matières utilisés sont archivés plutôt que supprimés. | ACCEPTED | 2026-06-22 | CORE-09C ajoute une décision lifecycle pour cours et matières : les éléments vides peuvent être supprimés, les éléments avec historique pédagogique sont archivés. | Les listes actives restent propres sans casser l'historique ; l'app affiche renommer, archiver ou supprimer selon la décision backend. | CORE-09C |
