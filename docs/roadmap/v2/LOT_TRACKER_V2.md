...
| CORE-11 | Session resume & history | MVP_STABLE | API + App | IN_PROGRESS | CORE-10A | CORE-11A, CORE-11B | Reprise de session et historique utilisateur. | CORE-11A terminé : reprise session quick et drafts restaurés. CORE-11B historique reste à faire. | `docs/core/CORE_11A_SESSION_DRAFT_RESUME_APP_REPORT.md`, `docs/core/CORE_11A_SESSION_DRAFT_RESUME_EVIDENCE_PACK.md` |
