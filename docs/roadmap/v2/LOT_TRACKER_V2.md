...
| STAB-02 | Frontend design system unification | MVP_STABLE | App | IN_PROGRESS | STAB-01C | STAB-02A, STAB-02B | Unifier les écrans legacy et premium. | Tests UI ciblés + anti-régression. | `docs/ui/STAB_02A_LEGACY_PREMIUM_ALIGNMENT_REPORT.md` |
