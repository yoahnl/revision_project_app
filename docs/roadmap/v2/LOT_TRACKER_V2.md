...
| CORE-09 | Source lifecycle & storage policy | MVP_STABLE | API + App | IN_PROGRESS | STAB-01A | CORE-09A, CORE-09B, CORE-09C | Sécuriser archive/suppression de sources et stockage. | Tests Prisma + API + UI. | `docs/core/CORE_09A_SOURCE_LIFECYCLE_APP_REPORT.md`, `docs/core/CORE_09B_STORAGE_CLEANUP_APP_NOTE.md` |
