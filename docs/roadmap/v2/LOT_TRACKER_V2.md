...
| QUALITY-00 | CI baseline | FOUNDATION | App + API | TODO | STAB-00B | QUALITY-00 | Ajouter une baseline CI avant les gros refactors. | Analyse, build, tests ciblés et e2e critiques sur PR. | À créer |
