...
| CORE-10 | Question bank production hardening | MVP_STABLE | API + App | IN_PROGRESS | CORE-09A | CORE-10A, CORE-10B, CORE-10C | Rendre la banque de questions robuste et moins synchrone. | CORE-10A terminé ; CORE-10B/C restent à faire. | `docs/core/CORE_10A_ASYNC_QUESTION_BANK_READINESS_APP_REPORT.md` |
