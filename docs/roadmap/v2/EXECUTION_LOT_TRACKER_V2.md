...
| STAB-02B | STAB-02 | MVP_STABLE | App | DONE | STAB-02A | Aucun | Extraire les widgets feature, isoler ou déprécier le legacy. | Parcours canonique isolé du legacy, inventaire créé, widgets lourds extraits sans nouvelle feature. | `docs/ui/STAB_02B_CANONICAL_FLOW_LEGACY_ISOLATION_REPORT.md` |
