...
| CORE-10B | CORE-10 | MVP_STABLE | App + API | DONE | CORE-10A | CORE-11A | Sélection multi-KU, verrouillage concurrence et UX quick target-aware. | Fix-2 validé localement et en runtime : disponibilité partielle 5/10/20/30, polling target-aware, Dokploy PREPARING -> READY et Marionette session 20 questions. | `docs/core/CORE_10B_MULTI_KU_SELECTION_CONCURRENCY_APP_NOTE.md`, `docs/core/CORE_10B_FIX_PREPARATION_COMPLETION_APP_NOTE.md`, `docs/core/CORE_10B_FIX_2_QUICK_READINESS_UX_APP_REPORT.md` |
| CORE-10C | CORE-10 | MVP_STABLE | App + API | DONE | CORE-10B | ADAPT-01 | Découpler QuestionBankService et ajouter métriques qualité/coût. | API découplée et testée ; garde-fous Flutter `NO_KNOWLEDGE_UNITS` et 409 target-aware couverts ; full Jest et full Flutter verts. | `docs/core/CORE_10C_QUESTION_BANK_DECOUPLING_METRICS_APP_REPORT.md` |
| CORE-11A | CORE-11 | MVP_STABLE | App + API | DONE | CORE-10A | CORE-10B, PLUS-01A | Sauvegarder brouillons de session et reprise. | Reprise depuis détail cours, drafts restaurés/sauvegardés, full Flutter vert. | `docs/core/CORE_11A_SESSION_DRAFT_RESUME_APP_REPORT.md`, `docs/core/CORE_11A_SESSION_DRAFT_RESUME_EVIDENCE_PACK.md` |
