...
| CORE-09C | CORE-09 | MVP_STABLE | App + API | DONE | CORE-09A | CORE-09B | Ajouter les APIs de lifecycle sujet/cours nécessaires à l'UX. | Renommer/archiver/supprimer safe disponibles via décisions backend et UI premium. | `docs/core/CORE_09C_SUBJECT_COURSE_LIFECYCLE_APP_REPORT.md` |
