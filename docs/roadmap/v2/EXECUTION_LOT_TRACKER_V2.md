...
| QUALITY-00 | QUALITY-00 | FOUNDATION | App + API | TODO | STAB-00B | STAB-01A | Installer une baseline CI reproductible. | Analyse, build, tests ciblés et e2e critiques sur PR. | À créer |
