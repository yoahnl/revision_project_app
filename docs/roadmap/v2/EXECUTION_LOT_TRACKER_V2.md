...
| CORE-10B | CORE-10 | MVP_STABLE | App + API | BLOCKED | CORE-10A | CORE-11A | Sélection multi-KU, verrouillage concurrence et UX quick target-aware. | Fix-2 valide localement la disponibilité partielle 5/10/20/30 et le polling target-aware ; validation Marionette/Dokploy reste non concluante. | `docs/core/CORE_10B_MULTI_KU_SELECTION_CONCURRENCY_APP_NOTE.md`, `docs/core/CORE_10B_FIX_PREPARATION_COMPLETION_APP_NOTE.md`, `docs/core/CORE_10B_FIX_2_QUICK_READINESS_UX_APP_REPORT.md` |
