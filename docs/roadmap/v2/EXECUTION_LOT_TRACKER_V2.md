...
| CORE-10B | CORE-10 | MVP_STABLE | API | DONE | CORE-10A | CORE-11A | Sélection multi-KU et verrouillage concurrence. | Répartition multi-notions et réservation optimiste implémentées côté API ; app compatible sans changement runtime. | `docs/core/CORE_10B_MULTI_KU_SELECTION_CONCURRENCY_APP_NOTE.md` |
