...
| CORE-10B | CORE-10 | MVP_STABLE | API | BLOCKED | CORE-10A | CORE-11A | Sélection multi-KU et verrouillage concurrence. | Correctif API ajouté pour readiness per-KU et worker, mais validation macOS réelle non exécutée faute de session Neralune Marionette connectable. | `docs/core/CORE_10B_MULTI_KU_SELECTION_CONCURRENCY_APP_NOTE.md`, `docs/core/CORE_10B_FIX_PREPARATION_COMPLETION_APP_NOTE.md` |
