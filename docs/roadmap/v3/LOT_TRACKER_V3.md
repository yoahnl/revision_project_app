...
| PLUS-03 | Préparation examen V1 | H1 | API + App | DONE | PLUS-02A, PLUS-02B | PLUS-03A, PLUS-03B | Créer un mode préparation examen distinct. | PLUS-03A a livré le contrat options/readiness et la page de configuration ; PLUS-03B livre la session exam, la soumission serveur, le résultat exam, l'historique exam et la réouverture résultat. | Rapports `PLUS_03A`, `PLUS_03B` |
