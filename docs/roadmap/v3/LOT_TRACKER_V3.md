...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| PLUS-02 | QCM complet / rich questions recovery | H1 | API + App | IN_PROGRESS | MVP core fermé, CORE-10, CORE-11 | PLUS-02A, PLUS-02B | Restaurer un QCM riche, sourcé, corrigé et historisé. | PLUS-02A a récupéré le contrat et le rendu rich closed ; PLUS-02B doit encore intégrer result/correction/history QCM riche. | `docs/roadmap/v3/PLUS_02A_QCM_RICH_QUESTIONS_RECOVERY_REPORT.md`, rapport `PLUS_02B` à créer |
