...
| `V4-03A` | Cours V4 frontend | Frontend | `NOT_STARTED` | Frontend | Bibliotheque cours compacte et premium | `V4-01A` | `CoursesHomePage`, course cards | Widget tests 0/1/n cours | `docs/roadmap/v4/evidence/V4-03A_cours_v4_frontend_EVIDENCE_PACK.md` | À confirmer | Eviter le dashboard de modes. |
...
| `R-V4-011` | Routes legacy cassees. | High | Frontend | Conserver routes, router tests, audit avant cleanup. | `V4-01B`, `V4-11A` | Open |
