...
| QB-01 | QB | H1 | API + App | DONE | RESET-01 | Corriger la sur-generation question bank et separer session count / pool target / per-KU target. | Tests API question bank/readiness + tests App readiness si wording change. | `QB_01_QUESTION_BANK_BUDGET_REPORT.md` | Planner livre; 35/65 corriges; MODE-01 reste TODO. |
