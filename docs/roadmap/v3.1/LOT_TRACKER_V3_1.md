...
| DEEP | Revision approfondie | H2 | API + App | DONE | MODE | DEEP-01A, DEEP-01B | Transformer la question ouverte en mode course-level complet. | Start, correction, lifecycle, result, history et reopen result livres et testes. | `DEEP_01A_COURSE_LEVEL_DEEP_START_REPORT.md`, `DEEP_01B_DEEP_RESULT_HISTORY_REPORT.md` |
