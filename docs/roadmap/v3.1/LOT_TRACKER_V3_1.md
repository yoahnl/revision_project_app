...
| DEEP | Revision approfondie | H2 | API + App | IN_PROGRESS | MODE | DEEP-01A, DEEP-01B | Transformer la question ouverte en mode course-level complet. | Start et correction livres; result, history et reopen result restent a livrer dans DEEP-01B. | `DEEP_01A_COURSE_LEVEL_DEEP_START_REPORT.md`, `DEEP_01B...` |
