...
| RICH | Course-level QCM complet | H1 | API + App | DONE | MODE | RICH-01 | Rendre les questions riches accessibles depuis le cours. | Page/entry course-level, presets 6/10/13, start reel, result et history existants conserves. | `RICH_01_COURSE_LEVEL_QCM_COMPLET_REPORT.md` |
